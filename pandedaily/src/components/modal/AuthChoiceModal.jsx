              ...
              >
                ...
                <div className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
                  ...
                  <motion.button
                    ...
                    className="w-full p-4 md:p-5 lg:p-6 rounded-lg md:rounded-xl border-2 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] group focus:outline-none focus:ring-2 focus:ring-[#9C4A15] focus:ring-offset-2"
                    style={{
